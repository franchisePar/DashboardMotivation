...
function App() {
  ...
  // ── FIX: Only CONFIRMED bookings count for "Today" ──
  const todayCount = useMemo(() => {
  const todayBookings = data?.latestReservations?.filter(b => {
...
const todayCount = data?.todayStats?.confirmedBookings || 0
  const totalReservations = totalFromMeta

  // Trend calc (keep as is or adjust)
      ...
      <div className="main-area">
        ...
        <main className="app-main">
          ...
          <section className="middle-section">
            <BrandStats stats={brandStats} bookings={data?.latestReservations || []} />
