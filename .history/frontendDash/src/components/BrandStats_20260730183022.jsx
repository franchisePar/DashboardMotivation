...
const BRAND_CONFIG = {
  UNITED: { 
    color: '#0f27a2',
    colorDark: '#ffffff',        // White text in dark mode
    bgSoft: 'rgba(15, 39, 162, 0.08)', 
    bgSoftDark: 'rgba(96, 165, 250, 0.15)',
    ringColor: '#0f27a2',
    ringColorDark: '#60a5fa',
    logo: '/assets/logos/United_Logo_BG.png',
    logoDark: '/assets/logos/United_Logo_White.png',
  },
  MOVIS:  { 
    color: '#f94231',
    colorDark: '#f94231',        // Same red in dark
    bgSoft: 'rgba(249, 66, 49, 0.08)', 
    bgSoftDark: 'rgba(249, 66, 49, 0.15)',
    ringColor: '#f94231',
    ringColorDark: '#f94231',
    logo: '/assets/logos/Movis_Logo_BG.png',
    logoDark: '/assets/logos/Movis_Logo_BG.png', // Same
  },
  DRIVO:  { 
    color: '#c8fa1b',
    colorDark: '#c8fa1b',        // Same lime in dark
    bgSoft: 'rgba(200, 250, 27, 0.12)', 
    bgSoftDark: 'rgba(200, 250, 27, 0.15)',
    ringColor: '#a3c520',
    ringColorDark: '#c8fa1b',
    logo: '/assets/logos/Drivo_Logo_BG.png',
    logoDark: '/assets/logos/Drivo_Logo_BG.png', // Same
  },
}
