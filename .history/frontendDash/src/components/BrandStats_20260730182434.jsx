...
const BRAND_CONFIG = {
  ...
  MOVIS:  { 
    color: '#f94231',           // MOVIS red (was blue!)
    bgSoft: 'rgba(249, 66, 49, 0.08)', 
    ringColor: '#f94231'        // MOVIS red (was blue!)
  },
  DRIVO:  { 
    color: '#c8fa1b',           // DRIVO lime (was blue!)
    bgSoft: 'rgba(200, 250, 27, 0.12)', 
    ringColor: '#a3c520'        // DRIVO green (was blue!)
  },
}
      ...
      {brandData.map((b) => (
        <div key={b.brand} style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: 1 }}>
            <BrandLogo brand="united" height={24} />
