...
export function LiveMap({ bookings = [], theme }) {
  ...
  // Space stars: a subtle star field surrounding the Earth.
  // They live just outside the atmosphere so they feel attached to the globe
  // instead of looking like a flat CSS background.
  useEffect(() => {
    ...
    for (let i = 0; i < starCount; i += 1) {
      // Keep stars in a shell around the Earth.
      const radius = 155 + Math.random() * 95
