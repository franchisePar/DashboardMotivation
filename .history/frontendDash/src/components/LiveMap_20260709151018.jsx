...
// ── Country → Lat/Lng cache (your partners + common countries) ──
const COUNTRY_COORDS = {
  ...
  'CORFU':                { lat: 39.6243, lng: 19.9217 },        // Greece
  'CROATIA':              { lat: 45.1000, lng: 15.2000 },
  'CYPRUS':               { lat: 35.1264, lng: 33.4299 },
  'CYPRES':               { lat: 35.1264, lng: 33.4299 },        // French spelling
  'DOMINICAN REPUBLIC':   { lat: 18.7357, lng: -70.1627 },
  'DOMINICAN':            { lat: 18.7357, lng: -70.1627 },
  'FLORIDA':              { lat: 27.6648, lng: -81.5158 },       // USA
  ...
  'MIAMI':                { lat: 25.7617, lng: -80.1918 },        // USA
  ...
  'TURCS AND CAICOS':     { lat: 21.6940, lng: -71.7979 },      // French spelling
  ...
  'CAYMAN ISLANDS':       { lat: 19.3138, lng: -81.2546 },
  'ARUBA':                { lat: 12.5211, lng: -69.9683 },
  'CURACAO':              { lat: 12.1696, lng: -68.9900 },
  'BONAIRE':              { lat: 12.2019, lng: -68.2624 },
  'SINT EUSTATIUS':       { lat: 17.4890, lng: -62.9730 },
  'SABA':                 { lat: 17.6355, lng: -63.2327 },
  ...
  'WALLIS AND FUTUNA':    { lat: -13.7688, lng: -177.1561 },
...
// Helper: get coords for a country
...
export function LiveMap({ bookings = [] }) {
  // Extract unique countries from bookings
  ...
  // Fallback: if no bookings, show partner countries
  ...
  const markersToShow = countryMarkers.length > 0 ? countryMarkers : partnerCountries
      ...
      >
        ...
        {markersToShow.map((marker) => (
          <Marker
            ...
            icon={createPulseMarker(marker.color)}
          >
            <Popup>
