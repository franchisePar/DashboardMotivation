...
const BRAND_CONFIGS = {
  UNITED: { color: 'var(--united)', glow: 'rgba(15, 39, 162, 0.3)', logo: '/assets/logos/United_Logo_BG.png' },
  MOVIS:  { color: 'var(--movis)', glow: 'rgba(14, 165, 233, 0.3)', logo: '/assets/logos/Movis_Logo_BG.png' },
  DRIVO:  { color: 'var(--drivo-text)', glow: 'rgba(245, 158, 11, 0.3)', logo: '/assets/logos/Drivo_Logo_BG.png' }
}
...
const CONFETTI_COLORS = ['var(--united)', 'var(--movis)', 'var(--drivo-text)', '#eab308', 'var(--success)', '#a855f7']
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', padding: '16px 0' }}>
          ...
          <span style={{ fontWeight: 900, color: isCancelled ? 'var(--muted)' : 'var(--text-primary)', fontSize: '42px', letterSpacing: '-0.03em', textShadow: isCancelled ? 'none' : `0 0 30px ${brandConfig.glow}`, lineHeight: 1 }}>
