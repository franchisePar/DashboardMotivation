...
// TRUE 3D EARTH VERSION
// Requires:
//   npm install react-globe.gl three
//
// This replaces the MapLibre globe with a real Three.js sphere.
// It keeps the same bookings/country/brand data model used by the
// original LiveMap component.
...
export function LiveMap({ bookings = [], theme }) {
  ...
  const atmosphereColor = isDark ? '#3B82F6' : '#8DB7E8'
    ...
    <div
      ...
      style={{
        ...
        background: isDark
          ...
          : 'radial-gradient(circle at 50% 45%, #FFFFFF 0%, #EEF3F8 55%, #E4EAF1 100%)',
      }}
    >
      <Globe
        ref={globeRef}
