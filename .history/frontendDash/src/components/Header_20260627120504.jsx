...
export function Header({ connected, lastUpdated, onRefresh }) {
  ...
  // Brand logo data
  const brands = [
    { name: 'United', logo: '/public/assets/logos/United-Logo.jpg', color: '#3b82f6' },
    { name: 'Movis', logo: '/public/assets/logos/Movis-Logo.png', color: '#f97316' },
    { name: 'Drivo', logo: '/public/assets/logos/Drivo-logo.png', color: '#eab308' },
  ]
