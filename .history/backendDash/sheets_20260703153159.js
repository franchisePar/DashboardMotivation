...
function parseDate(raw) {
  ...
  // Try 4: Just date DD/MM/YYYY or YYYY-MM-DD
...
function isToday(date) {
  ...
  // This is more accurate than UTC for same-day comparison
...
async function fetchSheetData() {
  try {
    ...
    const response = await sheets.spreadsheets.values.get({
      ...
      range: "A2:E10000",
      // Request values as formatted strings to get dates in readable format
