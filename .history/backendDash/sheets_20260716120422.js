...
// ═══════════════════════════════════════════════════════════
// isToday — Uses LOCAL date comparison (fixes 1h offset)
// ═══════════════════════════════════════════════════════════
...
function buildDashboardData(reservations) {
  ...
  console.log('hourlyData (non-zero):', JSON.stringify(hourlyData.filter(h => h.bookings > 0), null, 2));
  ...
  console.log('🔥 RETURNING:', JSON.stringify({
    ...
    hourlyDataNonZero: result.hourlyData.filter(h => h.bookings > 0).length,
